...
- This run: `pack_portable.py.part04`–`part07` (8000 bytes each)
...
- This run payload: pack_portable.py.part04–part07 (8000 bytes each) + LARGE_FILES + VERSION 0.5.56 + run 20260916-1620.
