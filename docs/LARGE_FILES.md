...
- `pack_portable.py.part01`–`part06` targeted on main at 8000 bytes each
- `pack_portable.py.part20` on main
- `pack_portable.py.part07`–`part19` still local-only (each 8000 except last)
