...
def main():
    ...
    with st.sidebar:
        ...
        perm_mode = st.selectbox(
            ...
            index=1,
            help="session_allow auto-approves tools after first approval. Low-risk tools (github, read, search, pinchtab) always auto-approve.",
        )
    ...
    with col_side:
        ...
        st.caption(
            ...
            "(git, code-review, implementation, browser, …) run → results merge."
        )
        domains_avail = [
            "orchestrator", "general", "git", "code-review", "implementation",
            "testing", "research", "frontend", "backend", "security", "docs", "browser",
        ]
        st.markdown(
        ...
        if sources:
            ...
            st.caption("Sources from web_search / github / pinchtab appear here")
